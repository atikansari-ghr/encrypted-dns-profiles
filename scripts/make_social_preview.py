...
# Palette lifted from docs/screenshots/provider-comparison.svg so the card
# reads as part of the same visual system.
COLOR_BACKGROUND = (255, 255, 255)
COLOR_ACCENT = (46, 90, 172)  # #2E5AAC
...
def generate_social_preview(output_path: Path = OUTPUT_PATH) -> Path:
    ...
    draw.text((margin_left, y), PROVIDERS_LINE, font=providers_font, fill=COLOR_ACCENT)
    providers_bbox = draw.textbbox((margin_left, y), PROVIDERS_LINE, font=providers_font)
    y = providers_bbox[3] + 26
